...
import org.syswin.fences.models.*;
...
public class FenceRepositoryTest extends AbstractTestNGSpringContextTests {
    ...
    public void populateDBWithDummy () {
        ...
        /*Adding users to DB*/
        User alexandruCozma = new User ("Alexandru", "Cozma", "0722481227", "alecsandru.cozma@gmail.com", "1", adminPermission);
        userRepository.save (alexandruCozma);

        User mihaiCiorobea = new User ("Mihai", "Ciorobrea", "0722112211", "mihai.ciorobea@gmail.com", "2", adminPermission);
        userRepository.save (mihaiCiorobea);

        User codrutaBaduna = new User ("Codruta", "Baduna", "0734565855", "codruta.baduna@gmail.com", "3", adminPermission);
        userRepository.save (codrutaBaduna);

        User adelaVulcanescu = new User ("Adela", "Vulcanescu", "072341988", "adela.vulcanescu@gmail.com", "4", adminPermission);
        ...
        /*Create objectives*/
        List<Fence> obj1Fences = new ArrayList<Fence> ();
        ...
        List<Fence> obj2Fences = new ArrayList<Fence> ();
        ...
        List<Fence> obj3Fences = new ArrayList<Fence> ();
        ...
        List<Fence> obj4Fences = new ArrayList<Fence> ();
